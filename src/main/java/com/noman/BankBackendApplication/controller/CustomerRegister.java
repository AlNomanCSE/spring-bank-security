...
import com.noman.BankBackendApplication.constants.ApplicationConstance;
import com.noman.BankBackendApplication.model.Customer;
import com.noman.BankBackendApplication.model.LoginRequestDTO;
import com.noman.BankBackendApplication.model.LoginResponseDTO;
    ...
    public ResponseEntity<LoginResponseDTO> apiLogin(@RequestBody LoginRequestDTO loginRequest) {
        ...
        if (null != authenticationResponse && authenticationResponse.isAuthenticated()) {
            ...
            if (null != env) {
                ...
                jwt = Jwts.builder().issuer("NBank").subject("JWT Token")
        ...
        return ResponseEntity.status(HttpStatus.OK).header(ApplicationConstance.JWT_HEADER, jwt).body(new LoginResponseDTO(HttpStatus.OK.getReasonPhrase(), jwt));
    }
